#!/usr/bin/env python3
"""
Скрипт для добавления обоих owner пользователей в базу данных
"""
...
async def add_owners():
    """Добавление owner пользователей в базу данных"""
    try:
        ...
        async with get_db_session() as session:
            ...
            print("✅ Both owners added successfully")
